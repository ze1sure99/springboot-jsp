...
<%
    ...
    eBusMerchantCommonRequest.dicRequest.put("TrxType", "StaticIdentifyVerifyReq");
    ...
    eBusMerchantCommonRequest.dicRequest.put("ClientName", request.getParameter("ClientName"));                    //账户户名       （必要信息）
    eBusMerchantCommonRequest.dicRequest.put("AccNo", request.getParameter("AccNo"));                    //银行帐号       （必要信息）
    ...
    eBusMerchantCommonRequest.dicRequest.put("MobileNo", request.getParameter("MobileNo")); //手机号
