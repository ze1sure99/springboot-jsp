...
<%
    ...
    eBusMerchantCommonRequest.dicRequest.put("TrxType", "UnifiedSignApply");
    ...
    eBusMerchantCommonRequest.dicRequest.put("InvaidDate", request.getParameter("InvaidDate"));
    eBusMerchantCommonRequest.dicRequest.put("MerCustomNo", request.getParameter("MerCustomNo"));
