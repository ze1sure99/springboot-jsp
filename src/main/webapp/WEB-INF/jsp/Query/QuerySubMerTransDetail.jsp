...
<%
    ...
    eBusMerchantCommonRequest.dicRequest.put("TrxType", "QuerySubMerTransDetail");
    eBusMerchantCommonRequest.dicRequest.put("SubMerchantNo", request.getParameter("SubMerchantNo"));
    eBusMerchantCommonRequest.dicRequest.put("selType", request.getParameter("selType"));
    eBusMerchantCommonRequest.dicRequest.put("Status", request.getParameter("Status"));
    eBusMerchantCommonRequest.dicRequest.put("sDate", request.getParameter("sDate"));
    eBusMerchantCommonRequest.dicRequest.put("eDate", request.getParameter("eDate"));
